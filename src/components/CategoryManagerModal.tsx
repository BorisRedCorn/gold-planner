...
const inputClass =
  'w-full rounded-lg border border-gold-500/20 bg-black/40 px-3 py-2 text-zinc-200 outline-none transition-colors placeholder:text-zinc-600 focus:border-gold-500/50'
        ...
        >
          ...
          >
                  ...
                  {editingId === cat.id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <button
                          type="button"
                          onClick={saveEdit}
                          className="cursor-pointer rounded-lg border border-gold-500/40 bg-gold-500/15 px-4 py-2 text-sm text-gold-300"
                        >
                          Сохранить
                        </button>
                        <button
                          ...
                          className="cursor-pointer rounded-lg px-4 py-2 text-sm text-zinc-500"
                        >
                          Отмена
                        </button>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-zinc-200">{cat.label}</p>
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="cursor-pointer rounded-lg border border-gold-500/20 px-3 py-1.5 text-sm text-gold-500/70 hover:border-gold-500/40"
                        >
                          ✎
                        </button>
                        <button
                          ...
                          className="cursor-pointer rounded-lg border border-red-500/20 px-3 py-1.5 text-sm text-red-400/70 hover:border-red-500/40"
                        >
                          ✕
                        </button>
                      </div>
            ...
            <form onSubmit={handleAdd} className="mb-4 space-y-3 border-t border-gold-500/10 pt-4">
              ...
              <button
                type="submit"
                className="w-full cursor-pointer rounded-xl border border-gold-500/40 bg-gold-500/10 py-2.5 text-gold-400 transition-colors hover:bg-gold-500/20"
              >
                + Добавить категорию
              </button>
            </form>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="cursor-pointer rounded-lg border border-gold-500/15 px-4 py-2 text-sm text-zinc-500 hover:text-gold-500"
              >
              ...
              <button
                type="button"
                onClick={onClose}
                className="ml-auto cursor-pointer rounded-lg border border-gold-500/30 px-4 py-2 text-sm text-gold-400"
              >
                Готово
              </button>
            </div>
